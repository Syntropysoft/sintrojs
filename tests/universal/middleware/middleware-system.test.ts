 ...
 * Principio: Composición funcional
 */
const testPathSpecificMiddleware = (app: SyntroJS, path: string, middlewareName: string): SyntroJS => {
  const middleware = createPureMiddleware(middlewareName);
...
describe('Middleware System', () => {
  ...
  it('should handle guard clauses properly', () => {
    ...
    expect(() => app.use('' as any, createPureMiddleware('test'))).toThrow('Middleware or path is required');
  });
});
