...
async function main() {
  ...
  try {
    ...
    console.log(
      `   SyntroJS UltraFast 10 concurrent: ${rps10uf} req/sec (${successful10uf.length}/10)`,
    );
    ...
    console.log(
      `   SyntroJS UltraFast 100 concurrent: ${rps100uf} req/sec (${successful100uf.length}/100)`,
    );
    ...
    console.log(
      `   SyntroJS UltraFast 1000 concurrent: ${rps1000uf} req/sec (${successful1000uf.length}/1000)`,
    );
    ...
    console.log(
      `   SyntroJS Standard 10 concurrent: ${rps10s} req/sec (${successful10s.length}/10)`,
    );
    ...
    console.log(
      `   SyntroJS Standard 100 concurrent: ${rps100s} req/sec (${successful100s.length}/100)`,
    );
    ...
    console.log(
      `   SyntroJS Standard 1000 concurrent: ${rps1000s} req/sec (${successful1000s.length}/1000)`,
    );
