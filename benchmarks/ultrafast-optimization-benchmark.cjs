...
async function main() {
  ...
  try {
    ...
    console.log(
      `   SyntroJS Original 10 concurrent: ${rps10o} req/sec (${successful10o.length}/10)`,
    );
    ...
    console.log(
      `   SyntroJS Original 100 concurrent: ${rps100o} req/sec (${successful100o.length}/100)`,
    );
    ...
    console.log(
      `   SyntroJS Original 1000 concurrent: ${rps1000o} req/sec (${successful1000o.length}/1000)`,
    );
    ...
    console.log(
      `   SyntroJS UltraFast 10 concurrent: ${rps10u} req/sec (${successful10u.length}/10)`,
    );
    ...
    console.log(
      `   SyntroJS UltraFast 100 concurrent: ${rps100u} req/sec (${successful100u.length}/100)`,
    );
    ...
    console.log(
      `   SyntroJS UltraFast 1000 concurrent: ${rps1000u} req/sec (${successful1000u.length}/1000)`,
    );
